...
- **test:** Update GetVariables test for renamed variable_ids -> names ([`b2af745`](https://github.com/oisee/vibing-steampunk/commit/b2af7453d9ca1bbe404d36a074f72c42d77206b5))
...
- Increase lockWithRetry to 5 attempts with 1-4s backoff ([`dfb9565`](https://github.com/oisee/vibing-steampunk/commit/dfb9565598391a1d28f1cfcad27ee664512f4d3f))
...
- **install:** Skip AMDP on non-HANA, retry lock after create, clean package exists msg ([`689121e`](https://github.com/oisee/vibing-steampunk/commit/689121ec39bf5861089cc9e6b52799353dfcbe33))
